...
namespace Ordering.Domain.Models.OrderAggregate
{
        ...
        : Entity, IAggregateRoot
    {
        ...
        // DDD Patterns comment This Order AggregateRoot's method "AddOrderitem()" should be the
        // only way to add Items to the Order, so any behavior (discounts, etc.) and validations are
